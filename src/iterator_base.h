#ifndef TOYSTL_SRC_ITERATOR_BASE_H_
#define TOYSTL_SRC_ITERATOR_BASE_H_
...
struct iterator_traits<T*> {
  using iterator_category =
      random_access_iterator_tag;  // 原生指针是一种 Random Access Iterator
  using value_type = T;
...
inline typename iterator_traits<InputItertor>::difference_type distance(
    InputItertor first, InputItertor last) {
...
// /**
//  * 当前迭代器向前移动 n 步后的迭代器
//  * @tparam InputIterator 迭代器类型。Input Iterator
//  和它的"强化"迭代器都是合法的参数。
//  * @param it 迭代器
//  * @param n 距离
//  * @return 移动后的迭代器
//  */
// template <class InputIterator>
// inline InputIterator next(InputIterator it, typename
// iterator_traits<InputIterator>::difference_type n = 1) {
//     advance(it, n);
...
// /**
//  * 当前迭代器向后移动 n 步后的迭代器
//  * @tparam BidirectionalIterator 迭代器类型。Bidirectional Iterator
//  和它的"强化"迭代器都是合法的参数。
//  * @param it 迭代器
//  * @param n 距离（非负数）
//  * @return 移动后的迭代器
...
// inline BidirectionalIterator prev(BidirectionalIterator it, typename
...
#endif  // TOYSTL_SRC_ITERATOR_BASE_H_